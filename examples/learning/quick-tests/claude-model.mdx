...
Full source: [cookbook/08_learning/06_quick_tests/04_claude_model.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/08_learning/06_quick_tests/04_claude_model.py)
