...
Full source: [cookbook/08_learning/02_user_profile/01_always_extraction.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/08_learning/02_user_profile/01_always_extraction.py)
