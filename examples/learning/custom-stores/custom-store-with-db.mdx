...
Full source: [cookbook/08_learning/08_custom_stores/02_custom_store_with_db.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/08_learning/08_custom_stores/02_custom_store_with_db.py)
