---
title: "Extraction Limits: Preventing Runaway Loops"
description: "Configure max_updates_per_run to cap memory updates per extraction."
source: cookbook/08_learning/01_basics/6_extraction_limits.py
---

```python extraction_limits.py
"""
...
Full source: [cookbook/08_learning/01_basics/6_extraction_limits.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/08_learning/01_basics/6_extraction_limits.py)
