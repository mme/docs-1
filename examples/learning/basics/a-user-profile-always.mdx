...
Full source: [cookbook/08_learning/01_basics/1a_user_profile_always.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/08_learning/01_basics/1a_user_profile_always.py)
