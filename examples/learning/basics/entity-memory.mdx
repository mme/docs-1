...
description: "Entity memory is the agent's knowledge about the WORLD - the people, projects, companies and systems around the user - as opposed to user memory, which is about the user themselves."
source: cookbook/08_learning/01_basics/5_entity_memory.py
---
...
<Steps>
  ...
  <Step title="Run the example">
    Save the code above as `entity_memory.py`, then run:
    ```bash
    python entity_memory.py
    ```
  </Step>
...
Full source: [cookbook/08_learning/01_basics/5_entity_memory.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/08_learning/01_basics/5_entity_memory.py)
