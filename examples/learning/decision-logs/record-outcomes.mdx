---
title: "Decision Logs: Recording Outcomes"
description: "The feedback half of the decision log: log_decision records the choice with its reasoning, and record_outcome closes the loop later with what actually happened."
source: cookbook/08_learning/09_decision_logs/02_record_outcomes.py
---

The feedback half of the decision log: log_decision records the choice with its reasoning, and record_outcome closes the loop later with what actually happened. Decision logging is AGENTIC-only - the agent logs deliberately; there is no automatic extraction pass.
...
Full source: [cookbook/08_learning/09_decision_logs/02_record_outcomes.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/08_learning/09_decision_logs/02_record_outcomes.py)
