---
title: "Composition: The Manual Door"
description: "learning= is the automatic door: the framework injects context, instructions and tools for you."
source: cookbook/08_learning/11_composition/basic.py
---
...
Full source: [cookbook/08_learning/11_composition/basic.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/08_learning/11_composition/basic.py)
