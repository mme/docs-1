---
title: "Basic"
description: "Discord Bot Run an Agno agent as a Discord bot with DiscordClient."
source: cookbook/integrations/discord/basic.py
---
...
Full source: [cookbook/integrations/discord/basic.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/integrations/discord/basic.py)
