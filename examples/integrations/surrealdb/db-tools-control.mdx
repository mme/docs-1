...
Full source: [cookbook/integrations/surrealdb/db_tools_control.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/integrations/surrealdb/db_tools_control.py)
