...
Full source: [cookbook/integrations/surrealdb/memory_search_surreal.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/integrations/surrealdb/memory_search_surreal.py)
