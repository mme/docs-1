...
Full source: [cookbook/integrations/surrealdb/standalone_memory_surreal.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/integrations/surrealdb/standalone_memory_surreal.py)
