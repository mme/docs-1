...
Full source: [cookbook/integrations/surrealdb/custom_memory_instructions.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/integrations/surrealdb/custom_memory_instructions.py)
