...
Full source: [cookbook/integrations/parallel/06_research_team.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/integrations/parallel/06_research_team.py)
