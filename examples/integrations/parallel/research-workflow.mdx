...
Full source: [cookbook/integrations/parallel/07_research_workflow.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/integrations/parallel/07_research_workflow.py)
