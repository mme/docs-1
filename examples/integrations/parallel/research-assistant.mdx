...
Full source: [cookbook/integrations/parallel/04_research_assistant.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/integrations/parallel/04_research_assistant.py)
