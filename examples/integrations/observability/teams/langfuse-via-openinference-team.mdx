...
Full source: [cookbook/observability/teams/langfuse_via_openinference_team.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/observability/teams/langfuse_via_openinference_team.py)
