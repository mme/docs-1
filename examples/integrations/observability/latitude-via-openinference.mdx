...
Full source: [cookbook/observability/latitude_via_openinference.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/observability/latitude_via_openinference.py)
