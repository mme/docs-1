...
Full source: [cookbook/observability/logfire_via_openinference.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/observability/logfire_via_openinference.py)
