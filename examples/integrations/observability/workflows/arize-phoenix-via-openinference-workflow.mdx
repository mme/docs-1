...
Full source: [cookbook/observability/workflows/arize_phoenix_via_openinference_workflow.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/observability/workflows/arize_phoenix_via_openinference_workflow.py)
