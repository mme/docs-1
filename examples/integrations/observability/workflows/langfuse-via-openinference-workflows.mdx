...
Full source: [cookbook/observability/workflows/langfuse_via_openinference_workflows.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/observability/workflows/langfuse_via_openinference_workflows.py)
