...
Full source: [cookbook/observability/arize_phoenix_via_openinference_local.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/observability/arize_phoenix_via_openinference_local.py)
