...
Full source: [cookbook/observability/langfuse_via_openinference_response_model.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/observability/langfuse_via_openinference_response_model.py)
