...
Full source: [cookbook/observability/arize_phoenix_moving_traces_to_different_projects.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/observability/arize_phoenix_moving_traces_to_different_projects.py)
