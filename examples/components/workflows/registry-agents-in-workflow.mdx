...
Full source: [cookbook/93_components/workflows/registry_agents_in_workflow.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/93_components/workflows/registry_agents_in_workflow.py)
