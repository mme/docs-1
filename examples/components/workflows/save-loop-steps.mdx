...
Full source: [cookbook/93_components/workflows/save_loop_steps.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/93_components/workflows/save_loop_steps.py)
