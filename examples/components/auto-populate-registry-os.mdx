...
Full source: [cookbook/93_components/auto_populate_registry_os.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/93_components/auto_populate_registry_os.py)
