...
Full source: [cookbook/91_tools/parallel/investment_monitor.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/91_tools/parallel/investment_monitor.py)
