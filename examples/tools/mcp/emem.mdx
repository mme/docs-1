---
title: "Emem"
description: "MCP emem Agent - Shared Memory for AI Agents Working in the Real World."
...
Full source: [cookbook/91_tools/mcp/emem.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/91_tools/mcp/emem.py)
