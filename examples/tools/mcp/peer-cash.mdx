---
title: "Peer Cash MCP Agent - Prepare custody-separated cash-outs"
description: "This example connects Agno to Peer Cash through its published MCP server."
source: cookbook/91_tools/mcp/peer_cash.py
---
...
Full source: [cookbook/91_tools/mcp/peer_cash.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/91_tools/mcp/peer_cash.py)
