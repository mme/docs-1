...
Full source: [cookbook/91_tools/other/stop_after_tool_call_dual_inheritance.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/91_tools/other/stop_after_tool_call_dual_inheritance.py)
