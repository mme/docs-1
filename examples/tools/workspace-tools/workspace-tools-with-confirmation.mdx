...
Full source: [cookbook/91_tools/workspace_tools/workspace_tools_with_confirmation.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/91_tools/workspace_tools/workspace_tools_with_confirmation.py)
