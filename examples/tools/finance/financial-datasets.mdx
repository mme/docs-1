---
title: "FinanceTools with financialdatasets.AI"
description: "Same agent as 01_market_brief.py, different data provider."
source: cookbook/91_tools/finance/02_financial_datasets.py
---

```python financial_datasets.py
"""
...
<Steps>
  ...
  <Step title="Run the example">
    Save the code above as `financial_datasets.py`, then run:
    ```bash
    python financial_datasets.py
    ```
  </Step>
...
Full source: [cookbook/91_tools/finance/02_financial_datasets.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/91_tools/finance/02_financial_datasets.py)
