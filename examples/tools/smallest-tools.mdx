---
title: "Smallest AI text-to-speech tools"
description: "Requires the SMALLEST_API_KEY environment variable."
source: cookbook/91_tools/smallest_tools.py
---

Requires the SMALLEST_API_KEY environment variable. Get an API key at https://app.smallest.ai/dashboard (Developer -> API Keys).

```python smallest_tools.py
"""
...
<Steps>
  ...
  <Step title="Export your API keys">
    ...
    $Env:SMALLEST_API_KEY="your_smallest_api_key_here"
    ```
    </CodeGroup>
  </Step>

  <Step title="Run the example">
    Save the code above as `smallest_tools.py`, then run:
    ```bash
    python smallest_tools.py
    ```
  </Step>
...
Full source: [cookbook/91_tools/smallest_tools.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/91_tools/smallest_tools.py)
