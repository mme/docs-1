...
Full source: [cookbook/91_tools/google/gmail/followup_tracker.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/91_tools/google/gmail/followup_tracker.py)
