...
Full source: [cookbook/91_tools/google/sheets/sales_pipeline.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/91_tools/google/sheets/sales_pipeline.py)
