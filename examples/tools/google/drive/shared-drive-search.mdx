...
Full source: [cookbook/91_tools/google/drive/shared_drive_search.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/91_tools/google/drive/shared_drive_search.py)
