...
Full source: [cookbook/91_tools/google/slides/media_slides.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/91_tools/google/slides/media_slides.py)
