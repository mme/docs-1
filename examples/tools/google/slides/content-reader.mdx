...
Full source: [cookbook/91_tools/google/slides/content_reader.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/91_tools/google/slides/content_reader.py)
