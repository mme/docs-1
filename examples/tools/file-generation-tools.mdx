...
File Generation Tool Example This cookbook shows how to use the FileGenerationTool to generate various file types (JSON, CSV, PDF, TXT, DOCX, HTML, and source code). The tool can generate files from agent responses and make them available for download or further processing.
...
Full source: [cookbook/91_tools/file_generation_tools.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/91_tools/file_generation_tools.py)
