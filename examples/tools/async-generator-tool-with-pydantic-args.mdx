...
Full source: [cookbook/91_tools/async_generator_tool_with_pydantic_args.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/91_tools/async_generator_tool_with_pydantic_args.py)
