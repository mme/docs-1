...
Full source: [cookbook/91_tools/tool_hooks/tool_hook_in_toolkit_with_state_nested.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/91_tools/tool_hooks/tool_hook_in_toolkit_with_state_nested.py)
