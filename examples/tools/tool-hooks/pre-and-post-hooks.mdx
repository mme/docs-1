...
Full source: [cookbook/91_tools/tool_hooks/pre_and_post_hooks.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/91_tools/tool_hooks/pre_and_post_hooks.py)
