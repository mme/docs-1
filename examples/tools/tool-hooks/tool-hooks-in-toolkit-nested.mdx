...
Full source: [cookbook/91_tools/tool_hooks/tool_hooks_in_toolkit_nested.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/91_tools/tool_hooks/tool_hooks_in_toolkit_nested.py)
