...
description: "An operator agent that manages a knowledge base by chat: ingest a website page by page, list what is loaded grouped by site, check a site's status, and remove content."
source: cookbook/91_tools/knowledge_management_tools.py
---

```python knowledge_management_tools.py
"""
...
<Steps>
  ...
  <Step title="Install dependencies">
    ```bash
    uv pip install -U agno openai qdrant-client sqlalchemy
    ```
  </Step>
  ...
  <Step title="Run the example">
    Save the code above as `knowledge_management_tools.py`, then run:
    ```bash
    python knowledge_management_tools.py
    ```
  </Step>
...
Full source: [cookbook/91_tools/knowledge_management_tools.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/91_tools/knowledge_management_tools.py)
