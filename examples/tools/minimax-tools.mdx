---
title: "MiniMax Tools"
description: "Demonstrates MiniMax video generation tools."
source: cookbook/91_tools/minimax_tools.py
---
...
Full source: [cookbook/91_tools/minimax_tools.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/91_tools/minimax_tools.py)
