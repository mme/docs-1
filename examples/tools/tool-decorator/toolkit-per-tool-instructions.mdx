...
Full source: [cookbook/91_tools/tool_decorator/toolkit_per_tool_instructions.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/91_tools/tool_decorator/toolkit_per_tool_instructions.py)
