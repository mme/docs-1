...
Full source: [cookbook/91_tools/tool_decorator/tool_decorator.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/91_tools/tool_decorator/tool_decorator.py)
