...
description: "Give the agent several advisors, each with a description of what it is good at."
source: cookbook/91_tools/advisor_tools/02_multi_advisor.py
---
...
Full source: [cookbook/91_tools/advisor_tools/02_multi_advisor.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/91_tools/advisor_tools/02_multi_advisor.py)
