---
title: "Restricting Write Operations with write_tools"
description: "Context providers expose ``write_tools`` to customize or restrict what write operations an agent can perform."
source: cookbook/12_context/25_write_tools_restriction.py
---
...
```python write_tools_restriction.py
"""
...
<Steps>
  ...
  <Step title="Install dependencies">
    ```bash
    uv pip install -U agno google-api-python-client google-auth google-auth-httplib2 google-auth-oauthlib openai psycopg psycopg-binary sqlalchemy
    ```
  </Step>
...
Full source: [cookbook/12_context/25_write_tools_restriction.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/12_context/25_write_tools_restriction.py)
