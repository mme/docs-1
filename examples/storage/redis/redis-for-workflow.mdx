...
Full source: [cookbook/06_storage/redis/redis_for_workflow.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/06_storage/redis/redis_for_workflow.py)
