---
title: "Generated File Storage (S3)"
description: "Demonstrates media offload for files the agent *generates*, rather than files you attach."
source: cookbook/06_storage/11_media_storage_file_generation.py
---

```python media_storage_file_generation.py
"""
...
<Step title="Configure AWS credentials">
  ...
  <Step title="Run the example">
    Save the code above as `media_storage_file_generation.py`, then run:
    ```bash
    python media_storage_file_generation.py
    ```
  </Step>
...
Full source: [cookbook/06_storage/11_media_storage_file_generation.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/06_storage/11_media_storage_file_generation.py)
