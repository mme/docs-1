...
Full source: [cookbook/06_storage/json_db/json_for_workflows.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/06_storage/json_db/json_for_workflows.py)
