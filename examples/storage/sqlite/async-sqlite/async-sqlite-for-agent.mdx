...
Full source: [cookbook/06_storage/sqlite/async_sqlite/async_sqlite_for_agent.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/06_storage/sqlite/async_sqlite/async_sqlite_for_agent.py)
