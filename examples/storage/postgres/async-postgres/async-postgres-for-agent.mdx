...
Full source: [cookbook/06_storage/postgres/async_postgres/async_postgres_for_agent.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/06_storage/postgres/async_postgres/async_postgres_for_agent.py)
