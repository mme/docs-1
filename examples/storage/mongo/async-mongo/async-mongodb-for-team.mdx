...
Full source: [cookbook/06_storage/mongo/async_mongo/async_mongodb_for_team.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/06_storage/mongo/async_mongo/async_mongodb_for_team.py)
