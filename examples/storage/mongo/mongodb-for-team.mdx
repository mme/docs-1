...
description: "HackerNews research team stores its sessions in MongoDB with a structured Article output."
source: cookbook/06_storage/mongo/mongodb_for_team.py
---
...
<Steps>
  ...
  <Step title="Run the example">
    Save the code above as `mongodb_for_team.py`, then run:
    ```bash
    python mongodb_for_team.py
    ```
  </Step>
...
Full source: [cookbook/06_storage/mongo/mongodb_for_team.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/06_storage/mongo/mongodb_for_team.py)
