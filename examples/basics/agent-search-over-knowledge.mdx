...
Full source: [cookbook/00_quickstart/agent_search_over_knowledge.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/00_quickstart/agent_search_over_knowledge.py)
