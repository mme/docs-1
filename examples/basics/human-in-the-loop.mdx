---
title: "Human in the Loop - Approve Before the Agent Acts"
description: "This example pauses an agent before it executes a tool that has an external effect."
source: cookbook/00_quickstart/human_in_the_loop.py
---

This example pauses an agent before it executes a tool that has an external effect. The user can inspect the exact tool call, approve it, or reject it.
...
Full source: [cookbook/00_quickstart/human_in_the_loop.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/00_quickstart/human_in_the_loop.py)
