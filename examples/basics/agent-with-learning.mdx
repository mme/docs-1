---
title: "Agent with Learning - Research That Improves Across Users"
description: "This example gives an agent learned knowledge: reusable insights that become available to future users and sessions."
source: cookbook/00_quickstart/agent_with_learning.py
---
...
<Steps>
  ...
  <Step title="Install dependencies">
    ```bash
    uv pip install -U agno chromadb google-genai sqlalchemy yfinance
    ```
  </Step>
  ...
  <Step title="Run the example">
    Save the code above as `agent_with_learning.py`, then run:
    ```bash
    python agent_with_learning.py
    ```
  </Step>
...
Full source: [cookbook/00_quickstart/agent_with_learning.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/00_quickstart/agent_with_learning.py)
