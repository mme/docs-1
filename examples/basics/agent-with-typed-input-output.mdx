...
Define both input and output schemas for your agent. You get typed boundaries: validate what goes in and parse successful outputs.
...
Full source: [cookbook/00_quickstart/agent_with_typed_input_output.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/00_quickstart/agent_with_typed_input_output.py)
