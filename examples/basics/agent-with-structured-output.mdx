...
Get structured, typed responses from your agent. Instead of free-form text, a successful run returns a validated Pydantic model. The schema validates shape and types; tools and source checks establish facts.
...
Full source: [cookbook/00_quickstart/agent_with_structured_output.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/00_quickstart/agent_with_structured_output.py)
