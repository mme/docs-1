...
Full source: [cookbook/00_quickstart/agent_with_state_management.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/00_quickstart/agent_with_state_management.py)
