...
<Steps>
  ...
  <Step title="Install dependencies">
    ```bash
    uv pip install -U agno fastapi google-genai yfinance
    ```
  </Step>
...
Full source: [cookbook/00_quickstart/sequential_workflow.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/00_quickstart/sequential_workflow.py)
