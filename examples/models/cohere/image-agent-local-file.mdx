...
Full source: [cookbook/90_models/cohere/image_agent_local_file.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/90_models/cohere/image_agent_local_file.py)
