...
Full source: [cookbook/90_models/openrouter/chat/dynamic_model_router.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/90_models/openrouter/chat/dynamic_model_router.py)
