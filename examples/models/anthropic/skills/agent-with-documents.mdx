...
Full source: [cookbook/90_models/anthropic/skills/agent_with_documents.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/90_models/anthropic/skills/agent_with_documents.py)
