...
Full source: [cookbook/90_models/anthropic/prompt_caching_with_dynamic_block.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/90_models/anthropic/prompt_caching_with_dynamic_block.py)
