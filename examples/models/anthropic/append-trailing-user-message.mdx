...
Full source: [cookbook/90_models/anthropic/append_trailing_user_message.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/90_models/anthropic/append_trailing_user_message.py)
