...
Full source: [cookbook/90_models/groq/research_agent_seltz.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/90_models/groq/research_agent_seltz.py)
