...
Full source: [cookbook/90_models/openai/chat/custom_role_map.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/90_models/openai/chat/custom_role_map.py)
