...
Full source: [cookbook/90_models/openai/chat/audio_input_and_output_multi_turn.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/90_models/openai/chat/audio_input_and_output_multi_turn.py)
