...
Full source: [cookbook/90_models/openai/responses/file_input_direct.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/90_models/openai/responses/file_input_direct.py)
