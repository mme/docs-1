...
Full source: [cookbook/90_models/mistral/image_bytes_input_agent.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/90_models/mistral/image_bytes_input_agent.py)
