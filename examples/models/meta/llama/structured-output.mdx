...
Full source: [cookbook/90_models/meta/llama/structured_output.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/90_models/meta/llama/structured_output.py)
