...
Full source: [cookbook/90_models/meta/llama_openai/tool_use.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/90_models/meta/llama_openai/tool_use.py)
