---
title: "Moonshot Structured Output"
description: "Prefer native structured output."
source: cookbook/90_models/moonshot/structured_output.py
---
...
Full source: [cookbook/90_models/moonshot/structured_output.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/90_models/moonshot/structured_output.py)
