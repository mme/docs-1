...
Full source: [cookbook/90_models/google/gemini/pdf_input_local.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/90_models/google/gemini/pdf_input_local.py)
