...
Full source: [cookbook/90_models/google/gemini/file_upload_with_cache.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/90_models/google/gemini/file_upload_with_cache.py)
