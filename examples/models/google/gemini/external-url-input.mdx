...
Full source: [cookbook/90_models/google/gemini/external_url_input.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/90_models/google/gemini/external_url_input.py)
