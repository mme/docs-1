...
Full source: [cookbook/90_models/google/gemini/gemini_2_to_3.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/90_models/google/gemini/gemini_2_to_3.py)
