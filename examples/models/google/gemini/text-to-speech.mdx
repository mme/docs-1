...
Full source: [cookbook/90_models/google/gemini/text_to_speech.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/90_models/google/gemini/text_to_speech.py)
