...
Full source: [cookbook/90_models/google/gemini/video_input_file_upload.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/90_models/google/gemini/video_input_file_upload.py)
