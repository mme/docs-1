...
Full source: [cookbook/90_models/google/gemini_interactions/deep_research.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/90_models/google/gemini_interactions/deep_research.py)
