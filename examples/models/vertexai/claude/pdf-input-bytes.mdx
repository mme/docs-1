...
Full source: [cookbook/90_models/vertexai/claude/pdf_input_bytes.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/90_models/vertexai/claude/pdf_input_bytes.py)
