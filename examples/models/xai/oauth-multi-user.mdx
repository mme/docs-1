---
title: "xAI SuperGrok Per-User Sign-In"
description: "Several people share one deployment and each spends their own SuperGrok subscription."
source: cookbook/90_models/xai/oauth_multi_user.py
---
...
Full source: [cookbook/90_models/xai/oauth_multi_user.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/90_models/xai/oauth_multi_user.py)
