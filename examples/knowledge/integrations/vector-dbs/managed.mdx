...
Full source: [cookbook/07_knowledge/05_integrations/vector_dbs/03_managed.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/07_knowledge/05_integrations/vector_dbs/03_managed.py)
