...
Full source: [cookbook/07_knowledge/05_integrations/rag/agentic_rag_infinity_reranker.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/07_knowledge/05_integrations/rag/agentic_rag_infinity_reranker.py)
