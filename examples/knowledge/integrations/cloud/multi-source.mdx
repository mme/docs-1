...
Full source: [cookbook/07_knowledge/05_integrations/cloud/06_multi_source.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/07_knowledge/05_integrations/cloud/06_multi_source.py)
