...
Full source: [cookbook/07_knowledge/05_integrations/cloud/02_azure_sas.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/07_knowledge/05_integrations/cloud/02_azure_sas.py)
