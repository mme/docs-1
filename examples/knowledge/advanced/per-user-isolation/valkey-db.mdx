---
title: "Per-User Isolation: Valkey"
...
Full source: [cookbook/07_knowledge/04_advanced/07_per_user_isolation/valkey_db.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/07_knowledge/04_advanced/07_per_user_isolation/valkey_db.py)
