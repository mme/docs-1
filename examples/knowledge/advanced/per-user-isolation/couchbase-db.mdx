---
title: "Per-User Isolation: Couchbase"
description: "Each user gets a private view of one shared knowledge base."
source: cookbook/07_knowledge/04_advanced/07_per_user_isolation/couchbase_db.py
---
...
<Steps>
  ...
  <Step title="Install dependencies">
    ```bash
    uv pip install -U agno acouchbase couchbase openai
    ```
  </Step>
  ...
  <Step title="Run the example">
    Save the code above as `couchbase_db.py`, then run:
    ```bash
    python couchbase_db.py
    ```
  </Step>
...
Full source: [cookbook/07_knowledge/04_advanced/07_per_user_isolation/couchbase_db.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/07_knowledge/04_advanced/07_per_user_isolation/couchbase_db.py)
