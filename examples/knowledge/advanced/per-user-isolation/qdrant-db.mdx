---
title: "Per-User Isolation: Qdrant"
description: "Each user gets a private view of one shared knowledge base."
source: cookbook/07_knowledge/04_advanced/07_per_user_isolation/qdrant_db.py
---
...
<Steps>
  ...
  <Step title="Run the example">
    Save the code above as `qdrant_db.py`, then run:
    ```bash
    python qdrant_db.py
    ```
  </Step>
...
Full source: [cookbook/07_knowledge/04_advanced/07_per_user_isolation/qdrant_db.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/07_knowledge/04_advanced/07_per_user_isolation/qdrant_db.py)
