---
title: "Per-User Isolation: Pinecone"
description: "Each user gets a private view of one shared knowledge base."
source: cookbook/07_knowledge/04_advanced/07_per_user_isolation/pinecone_db.py
---
...
Full source: [cookbook/07_knowledge/04_advanced/07_per_user_isolation/pinecone_db.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/07_knowledge/04_advanced/07_per_user_isolation/pinecone_db.py)
