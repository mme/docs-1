...
Full source: [cookbook/07_knowledge/04_advanced/06_prefix_search.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/07_knowledge/04_advanced/06_prefix_search.py)
