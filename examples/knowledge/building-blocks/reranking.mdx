...
Full source: [cookbook/07_knowledge/02_building_blocks/03_reranking.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/07_knowledge/02_building_blocks/03_reranking.py)
