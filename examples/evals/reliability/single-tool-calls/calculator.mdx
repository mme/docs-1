...
Full source: [cookbook/09_evals/reliability/single_tool_calls/calculator.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/09_evals/reliability/single_tool_calls/calculator.py)
