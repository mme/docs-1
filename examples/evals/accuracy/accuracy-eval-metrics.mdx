...
Full source: [cookbook/09_evals/accuracy/accuracy_eval_metrics.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/09_evals/accuracy/accuracy_eval_metrics.py)
