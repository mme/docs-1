...
Full source: [cookbook/09_evals/performance/comparison/crewai_instantiation.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/09_evals/performance/comparison/crewai_instantiation.py)
