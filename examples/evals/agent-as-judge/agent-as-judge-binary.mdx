...
Full source: [cookbook/09_evals/agent_as_judge/agent_as_judge_binary.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/09_evals/agent_as_judge/agent_as_judge_binary.py)
