...
Full source: [cookbook/10_reasoning/models/anthropic/basic_reasoning_stream.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/10_reasoning/models/anthropic/basic_reasoning_stream.py)
