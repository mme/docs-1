...
Full source: [cookbook/10_reasoning/models/deepseek/ethical_dilemma.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/10_reasoning/models/deepseek/ethical_dilemma.py)
