...
Full source: [cookbook/10_reasoning/tools/groq_llama_finance_agent.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/10_reasoning/tools/groq_llama_finance_agent.py)
