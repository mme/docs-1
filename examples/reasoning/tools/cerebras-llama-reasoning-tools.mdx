...
Full source: [cookbook/10_reasoning/tools/cerebras_llama_reasoning_tools.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/10_reasoning/tools/cerebras_llama_reasoning_tools.py)
