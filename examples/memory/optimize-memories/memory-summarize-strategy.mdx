...
Full source: [cookbook/11_memory/optimize_memories/01_memory_summarize_strategy.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/11_memory/optimize_memories/01_memory_summarize_strategy.py)
