...
Full source: [cookbook/11_memory/memory_manager/04_memory_search.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/11_memory/memory_manager/04_memory_search.py)
