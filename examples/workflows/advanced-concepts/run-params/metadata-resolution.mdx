...
description: "Demonstrates the three-layer metadata resolution for Workflows: workflow.metadata < session.metadata < call-site metadata."
source: cookbook/04_workflows/06_advanced_concepts/run_params/metadata_resolution.py
---

```python metadata_resolution.py
"""
Metadata Resolution
=============================
...
<Steps>
  ...
  <Step title="Run the example">
    Save the code above as `metadata_resolution.py`, then run:
    ```bash
    python metadata_resolution.py
    ```
  </Step>
...
Full source: [cookbook/04_workflows/06_advanced_concepts/run_params/metadata_resolution.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/04_workflows/06_advanced_concepts/run_params/metadata_resolution.py)
