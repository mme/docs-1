...
Full source: [cookbook/04_workflows/01_basic_workflows/02_step_with_function/step_with_additional_data.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/04_workflows/01_basic_workflows/02_step_with_function/step_with_additional_data.py)
