...
Full source: [cookbook/04_workflows/01_basic_workflows/01_sequence_of_steps/sequence_of_steps.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/04_workflows/01_basic_workflows/01_sequence_of_steps/sequence_of_steps.py)
