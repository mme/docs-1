...
Full source: [cookbook/04_workflows/08_human_in_the_loop/loop/02_loop_confirmation_streaming.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/04_workflows/08_human_in_the_loop/loop/02_loop_confirmation_streaming.py)
