...
Full source: [cookbook/04_workflows/05_conditional_branching/selector_media_pipeline.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/04_workflows/05_conditional_branching/selector_media_pipeline.py)
