...
Full source: [cookbook/04_workflows/05_conditional_branching/step_choices_parameter.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/04_workflows/05_conditional_branching/step_choices_parameter.py)
