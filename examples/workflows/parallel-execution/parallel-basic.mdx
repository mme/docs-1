...
Full source: [cookbook/04_workflows/04_parallel_execution/parallel_basic.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/04_workflows/04_parallel_execution/parallel_basic.py)
