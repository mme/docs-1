...
Full source: [cookbook/04_workflows/02_conditional_execution/condition_with_else.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/04_workflows/02_conditional_execution/condition_with_else.py)
