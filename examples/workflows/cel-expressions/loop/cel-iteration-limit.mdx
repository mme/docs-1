...
Full source: [cookbook/04_workflows/07_cel_expressions/loop/cel_iteration_limit.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/04_workflows/07_cel_expressions/loop/cel_iteration_limit.py)
