...
Full source: [cookbook/03_teams/01_quickstart/02_respond_directly_router_team.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/03_teams/01_quickstart/02_respond_directly_router_team.py)
