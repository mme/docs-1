...
Full source: [cookbook/03_teams/01_quickstart/05_team_history.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/03_teams/01_quickstart/05_team_history.py)
