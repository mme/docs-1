...
Full source: [cookbook/03_teams/03_tools/member_tool_hooks.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/03_teams/03_tools/member_tool_hooks.py)
