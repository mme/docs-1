...
Full source: [cookbook/03_teams/19_multimodal/image_to_structured_output.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/03_teams/19_multimodal/image_to_structured_output.py)
