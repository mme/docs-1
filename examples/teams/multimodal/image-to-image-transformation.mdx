...
Full source: [cookbook/03_teams/19_multimodal/image_to_image_transformation.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/03_teams/19_multimodal/image_to_image_transformation.py)
