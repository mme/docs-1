...
Full source: [cookbook/03_teams/12_learning/04_team_session_planning.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/03_teams/12_learning/04_team_session_planning.py)
