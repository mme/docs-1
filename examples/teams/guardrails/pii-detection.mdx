...
Full source: [cookbook/03_teams/18_guardrails/pii_detection.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/03_teams/18_guardrails/pii_detection.py)
