...
Full source: [cookbook/03_teams/18_guardrails/openai_moderation.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/03_teams/18_guardrails/openai_moderation.py)
