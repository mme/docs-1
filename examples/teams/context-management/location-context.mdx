...
Full source: [cookbook/03_teams/09_context_management/location_context.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/03_teams/09_context_management/location_context.py)
