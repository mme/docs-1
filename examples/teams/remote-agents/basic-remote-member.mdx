...
Full source: [cookbook/03_teams/23_remote_agents/01_basic_remote_member.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/03_teams/23_remote_agents/01_basic_remote_member.py)
