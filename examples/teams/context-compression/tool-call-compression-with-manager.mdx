...
Full source: [cookbook/03_teams/10_context_compression/tool_call_compression_with_manager.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/03_teams/10_context_compression/tool_call_compression_with_manager.py)
