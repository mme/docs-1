...
Full source: [cookbook/03_teams/15_distributed_rag/03_distributed_rag_with_reranking.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/03_teams/15_distributed_rag/03_distributed_rag_with_reranking.py)
