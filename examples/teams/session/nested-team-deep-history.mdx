---
title: "Deep Nested Team History"
description: "Use case: Customer reports a database issue."
source: cookbook/03_teams/07_session/nested_team_deep_history.py
---
...
```python nested_team_deep_history.py
"""
...
Full source: [cookbook/03_teams/07_session/nested_team_deep_history.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/03_teams/07_session/nested_team_deep_history.py)
