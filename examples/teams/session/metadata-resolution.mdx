...
description: "Demonstrates the three-layer metadata resolution for Teams: team.metadata < session.metadata < call-site metadata."
source: cookbook/03_teams/07_session/metadata_resolution.py
---
...
Full source: [cookbook/03_teams/07_session/metadata_resolution.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/03_teams/07_session/metadata_resolution.py)
