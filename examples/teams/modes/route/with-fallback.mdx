...
Full source: [cookbook/03_teams/02_modes/route/03_with_fallback.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/03_teams/02_modes/route/03_with_fallback.py)
