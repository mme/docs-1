...
Full source: [cookbook/03_teams/02_modes/coordinate/02_with_tools.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/03_teams/02_modes/coordinate/02_with_tools.py)
