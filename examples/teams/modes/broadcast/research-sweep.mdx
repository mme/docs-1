...
Full source: [cookbook/03_teams/02_modes/broadcast/03_research_sweep.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/03_teams/02_modes/broadcast/03_research_sweep.py)
