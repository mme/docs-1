...
Full source: [cookbook/03_teams/20_human_in_the_loop/external_tool_execution_stream.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/03_teams/20_human_in_the_loop/external_tool_execution_stream.py)
