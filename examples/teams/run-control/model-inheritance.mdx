...
Full source: [cookbook/03_teams/14_run_control/model_inheritance.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/03_teams/14_run_control/model_inheritance.py)
