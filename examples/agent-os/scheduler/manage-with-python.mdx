---
title: "Manage Schedules with Python"
description: "Use synchronous and genuinely asynchronous Postgres adapters with ScheduleManager, including safe cron updates, paging, and validation errors."
source: cookbook/05_agent_os/12_scheduler/03_manage_with_python.py
---

```python manage_with_python.py
"""
...
<Steps>
  ...
  <Step title="Install dependencies">
    ```bash
    uv pip install -U "agno[scheduler]" "psycopg[binary]" sqlalchemy
    ```
  </Step>
  ...
  <Step title="Run the example">
    Save the code above as `manage_with_python.py`, then run:
    ```bash
    python manage_with_python.py
    ```
  </Step>
...
Full source: [cookbook/05_agent_os/12_scheduler/03_manage_with_python.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/05_agent_os/12_scheduler/03_manage_with_python.py)
