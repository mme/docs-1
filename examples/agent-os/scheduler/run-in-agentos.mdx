---
title: "Run in AgentOS"
description: "Serve a Postgres-backed AgentOS scheduler, seed one minute schedule before startup, and observe a naturally claimed run appear in persisted history."
source: cookbook/05_agent_os/12_scheduler/01_run_in_agentos.py
---

```python run_in_agentos.py
"""
...
<Steps>
  ...
  <Step title="Run the example">
    Save the code above as `run_in_agentos.py`, then run:
    ```bash
    python run_in_agentos.py
    ```
  </Step>
...
Full source: [cookbook/05_agent_os/12_scheduler/01_run_in_agentos.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/05_agent_os/12_scheduler/01_run_in_agentos.py)
