---
title: "Reconnect to background AgentOS SSE streams"
description: "Use raw ``httpx`` to track ``event_index``, deliberately disconnect, and POST to the nested ``/resume`` route."
source: cookbook/05_agent_os/04_run_lifecycle/sse_reconnect.py
---
...
Full source: [cookbook/05_agent_os/04_run_lifecycle/sse_reconnect.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/05_agent_os/04_run_lifecycle/sse_reconnect.py)
