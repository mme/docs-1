---
title: "Cancel a background AgentOS run"
description: "Start a long non-streaming background run, cancel it through the nested run route, and poll the database-backed run until its status becomes CANCELLED."
source: cookbook/05_agent_os/04_run_lifecycle/cancel_run.py
---
...
Full source: [cookbook/05_agent_os/04_run_lifecycle/cancel_run.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/05_agent_os/04_run_lifecycle/cancel_run.py)
