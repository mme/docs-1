---
title: "Serve an Agent with a Local Skill"
description: "Load a skill from disk, expose its instructions and scripts to an Agent, and prove a real script execution through the AgentOS run API."
source: cookbook/05_agent_os/23_skills/basic.py
---
...
Full source: [cookbook/05_agent_os/23_skills/basic.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/05_agent_os/23_skills/basic.py)
