---
title: "Write an audit approval after an ephemeral HITL decision"
description: "``@approval(type=\"audit\")`` does not replace a HITL flag."
source: cookbook/05_agent_os/05_human_in_the_loop/audit_record.py
---
...
Full source: [cookbook/05_agent_os/05_human_in_the_loop/audit_record.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/05_agent_os/05_human_in_the_loop/audit_record.py)
