---
title: "Resolve a persistent AgentOS approval record"
description: "``@approval(type=\"required\")`` creates a database-backed approval record in addition to pausing the run."
source: cookbook/05_agent_os/05_human_in_the_loop/with_approval_record.py
---
...
```python with_approval_record.py
"""
...
Full source: [cookbook/05_agent_os/05_human_in_the_loop/with_approval_record.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/05_agent_os/05_human_in_the_loop/with_approval_record.py)
