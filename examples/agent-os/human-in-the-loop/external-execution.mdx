---
title: "Return an externally executed tool result to AgentOS"
description: "A member agent requests ``send_email``, but ``external_execution=True`` keeps the side effect outside the AgentOS process."
source: cookbook/05_agent_os/05_human_in_the_loop/external_execution.py
---
...
Full source: [cookbook/05_agent_os/05_human_in_the_loop/external_execution.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/05_agent_os/05_human_in_the_loop/external_execution.py)
