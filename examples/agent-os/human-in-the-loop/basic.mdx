---
title: "Confirm an ephemeral AgentOS tool call"
description: "Pause an agent run with ``@tool(requires_confirmation=True)``, inspect the pending tool returned by AgentOS, confirm it, and send the updated tool to the nested ``continue`` route."
source: cookbook/05_agent_os/05_human_in_the_loop/basic.py
---
...
Full source: [cookbook/05_agent_os/05_human_in_the_loop/basic.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/05_agent_os/05_human_in_the_loop/basic.py)
