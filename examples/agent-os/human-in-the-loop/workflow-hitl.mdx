---
title: "Resolve three workflow HITL pauses through AgentOS"
description: "One OS-served workflow pauses before a sensitive step, pauses again to collect step input, then pauses after producing a draft so a human can review its output."
source: cookbook/05_agent_os/05_human_in_the_loop/workflow_hitl.py
---
...
Full source: [cookbook/05_agent_os/05_human_in_the_loop/workflow_hitl.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/05_agent_os/05_human_in_the_loop/workflow_hitl.py)
