---
title: "Place persistent approval tools on a team leader or member"
description: "AgentOS propagates approval pauses differently depending on where the tool lives."
source: cookbook/05_agent_os/05_human_in_the_loop/team_approval.py
---
...
Full source: [cookbook/05_agent_os/05_human_in_the_loop/team_approval.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/05_agent_os/05_human_in_the_loop/team_approval.py)
