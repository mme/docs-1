---
title: "Refresh and Read AgentOS Metrics"
description: "Create a persisted agent run, refresh daily aggregates through POST /metrics/refresh, then read the stored result through GET /metrics."
source: cookbook/05_agent_os/13_observability/metrics.py
---
...
Full source: [cookbook/05_agent_os/13_observability/metrics.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/05_agent_os/13_observability/metrics.py)
