---
title: "Route AgentOS Traces to ClickHouse"
description: "Keep transactional sessions in SQLite while batching trace spans into a dedicated ClickHouse OLAP store."
source: cookbook/05_agent_os/13_observability/traces_to_clickhouse.py
---
...
```python traces_to_clickhouse.py
"""
...
<Steps>
  ...
  <Step title="Install dependencies">
    ```bash
    uv pip install -U "agno[clickhouse,os]" openai opentelemetry-api opentelemetry-exporter-otlp
    ```
  </Step>
...
Full source: [cookbook/05_agent_os/13_observability/traces_to_clickhouse.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/05_agent_os/13_observability/traces_to_clickhouse.py)
