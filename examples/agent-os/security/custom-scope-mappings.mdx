---
title: "Custom route-to-scope mappings"
description: "Override selected entries in the default AgentOS scope map and add a second application scope to agent runs."
source: cookbook/05_agent_os/07_security/custom_scope_mappings.py
---

Override selected entries in the default AgentOS scope map and add a second application scope to agent runs. The smoke proves the override on GET /config.
...
Full source: [cookbook/05_agent_os/07_security/custom_scope_mappings.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/05_agent_os/07_security/custom_scope_mappings.py)
