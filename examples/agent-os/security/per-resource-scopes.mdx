---
title: "Per-resource and wildcard scopes"
description: "Grant access to one agent, team, or workflow by id, or use a wildcard scope deliberately."
source: cookbook/05_agent_os/07_security/per_resource_scopes.py
---
...
Full source: [cookbook/05_agent_os/07_security/per_resource_scopes.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/05_agent_os/07_security/per_resource_scopes.py)
