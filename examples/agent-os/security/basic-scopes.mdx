---
title: "JWT scopes and audience verification"
description: "Protect AgentOS with an HS256 JWT, the default scope map, and an audience bound to this AgentOS instance."
source: cookbook/05_agent_os/07_security/basic_scopes.py
---
...
Full source: [cookbook/05_agent_os/07_security/basic_scopes.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/05_agent_os/07_security/basic_scopes.py)
