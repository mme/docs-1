---
title: "Service accounts for machine-to-machine authentication"
description: "Mint an opaque agno_pat_ token, use its current default scopes, and revoke it."
source: cookbook/05_agent_os/07_security/service_accounts.py
---
...
Full source: [cookbook/05_agent_os/07_security/service_accounts.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/05_agent_os/07_security/service_accounts.py)
