---
title: "Executable and pytest RBAC enforcement test"
description: "Exercise JWT authentication, audience validation, default agent/team/workflow scope mappings, component protection, admin bypass, and a fully local workflow run."
source: cookbook/05_agent_os/07_security/test_scopes.py
---
...
Full source: [cookbook/05_agent_os/07_security/test_scopes.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/05_agent_os/07_security/test_scopes.py)
