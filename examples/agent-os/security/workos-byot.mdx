---
title: "Bring your own WorkOS token issuer"
description: "Configure AgentOS to verify a WorkOS JWKS, read scopes from the permissions claim, and enforce the token audience."
source: cookbook/05_agent_os/07_security/workos_byot.py
---
...
<Steps>
  ...
  <Step title="Install dependencies">
    ```bash
    uv pip install -U "agno[os]" cryptography openai workos
    ```
  </Step>
...
Full source: [cookbook/05_agent_os/07_security/workos_byot.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/05_agent_os/07_security/workos_byot.py)
