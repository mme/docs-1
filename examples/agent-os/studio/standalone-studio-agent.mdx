---
title: "Compose and version an Agent without starting AgentOS"
description: "StudioTools can persist components directly through a synchronous database."
source: cookbook/05_agent_os/22_studio/standalone_studio_agent.py
---
...
Full source: [cookbook/05_agent_os/22_studio/standalone_studio_agent.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/05_agent_os/22_studio/standalone_studio_agent.py)
