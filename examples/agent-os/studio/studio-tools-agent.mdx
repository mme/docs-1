---
title: "Serve a Studio Agent that composes persisted components"
description: "AgentOS exposes code-defined Agents alongside components created by StudioTools."
source: cookbook/05_agent_os/22_studio/studio_tools_agent.py
---
...
Full source: [cookbook/05_agent_os/22_studio/studio_tools_agent.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/05_agent_os/22_studio/studio_tools_agent.py)
