---
title: "Dispatch Studio-built components from a runner-only Agent"
description: "StudioRunnerTools is the dispatch half of the Studio: list the components in the platform database and run one by id."
source: cookbook/05_agent_os/22_studio/studio_runner_dispatcher.py
---
...
Full source: [cookbook/05_agent_os/22_studio/studio_runner_dispatcher.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/05_agent_os/22_studio/studio_runner_dispatcher.py)
