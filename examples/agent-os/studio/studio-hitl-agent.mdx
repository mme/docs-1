---
title: "Resolve Studio composition pauses in the console"
description: "This standalone Studio Agent gathers a structured tool choice, requests free-text instructions, and pauses again before create_agent persists anything."
source: cookbook/05_agent_os/22_studio/studio_hitl_agent.py
---

This standalone Studio Agent gathers a structured tool choice, requests free-text instructions, and pauses again before create_agent persists anything. The console resolves RunRequirement objects and continues the same run.
...
<Steps>
  ...
  <Step title="Install dependencies">
    ```bash
    uv pip install -U "agno[scheduler]" anthropic openai sqlalchemy
    ```
  </Step>
...
Full source: [cookbook/05_agent_os/22_studio/studio_hitl_agent.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/05_agent_os/22_studio/studio_hitl_agent.py)
