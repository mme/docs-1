---
title: "Inspect Registry resources and manage persisted components"
description: "The Registry endpoint lists code-defined primitives."
source: cookbook/05_agent_os/22_studio/registry_and_components.py
---
...
```python registry_and_components.py
"""
...
Full source: [cookbook/05_agent_os/22_studio/registry_and_components.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/05_agent_os/22_studio/registry_and_components.py)
