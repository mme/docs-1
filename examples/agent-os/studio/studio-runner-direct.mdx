---
title: "StudioRunnerTools called directly: list, run, and refusal semantics"
description: "The runner's tools are plain methods, so a platform can call them without a wielding model."
source: cookbook/05_agent_os/22_studio/studio_runner_direct.py
---
...
```python studio_runner_direct.py
"""
...
Full source: [cookbook/05_agent_os/22_studio/studio_runner_direct.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/05_agent_os/22_studio/studio_runner_direct.py)
