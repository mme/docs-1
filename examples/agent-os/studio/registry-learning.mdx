---
title: "Wire Studio-built components to a Registry LearningMachine"
description: "Learning is the only memory surface a Studio-built component can be given, and the deployer decides what learning exists: every LearningMachine a built component may use is declared on the Registry, by name."
source: cookbook/05_agent_os/22_studio/registry_learning.py
---
...
Full source: [cookbook/05_agent_os/22_studio/registry_learning.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/05_agent_os/22_studio/registry_learning.py)
