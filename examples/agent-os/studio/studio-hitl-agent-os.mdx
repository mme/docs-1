---
title: "Resolve Studio composition pauses through AgentOS"
description: "This AgentOS lesson exposes the same three Studio pauses as the console lesson, but serializes them as Agent run tools."
source: cookbook/05_agent_os/22_studio/studio_hitl_agent_os.py
---
...
<Steps>
  ...
  <Step title="Install dependencies">
    ```bash
    uv pip install -U "agno[os,scheduler]" anthropic openai
    ```
  </Step>
...
Full source: [cookbook/05_agent_os/22_studio/studio_hitl_agent_os.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/05_agent_os/22_studio/studio_hitl_agent_os.py)
