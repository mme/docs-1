---
title: "Manage Knowledge over REST"
description: "Exercise the complete AgentOS knowledge-content lifecycle over raw HTTP: upload, poll processing, list, semantic search, delete, and verify deletion."
source: cookbook/05_agent_os/10_knowledge/rest_api_knowledge.py
---

```python rest_api_knowledge.py
"""
...
<Steps>
  ...
  <Step title="Run the example">
    Save the code above as `rest_api_knowledge.py`, then run:
    ```bash
    python rest_api_knowledge.py
    ```
  </Step>
...
Full source: [cookbook/05_agent_os/10_knowledge/rest_api_knowledge.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/05_agent_os/10_knowledge/rest_api_knowledge.py)
