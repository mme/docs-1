...
Serve one persistent agent as a FastAPI application. After the server starts, open http://localhost:7777/config to inspect the API surface, then connect the server to the AgentOS control plane at https://os.agno.com.
...
Full source: [cookbook/05_agent_os/basic.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/05_agent_os/basic.py)
