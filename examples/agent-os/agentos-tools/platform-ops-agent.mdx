...
description: "Give an agent a read-only ops view of the AgentOS it runs on with AgentOSTools."
source: cookbook/05_agent_os/25_agentos_tools/platform_ops_agent.py
---
...
Full source: [cookbook/05_agent_os/25_agentos_tools/platform_ops_agent.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/05_agent_os/25_agentos_tools/platform_ops_agent.py)
