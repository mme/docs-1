---
title: "Send and Receive Media through Telegram"
description: "Use Gemini to understand photos, voice notes, audio, video, and documents received from Telegram."
source: cookbook/05_agent_os/18_telegram/media.py
---
...
Full source: [cookbook/05_agent_os/18_telegram/media.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/05_agent_os/18_telegram/media.py)
