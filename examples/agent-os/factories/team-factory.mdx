---
title: "Build a Team per Request"
description: "Register a TeamFactory that creates a fresh two-role support Team with tenant-specific instructions for every Team run."
source: cookbook/05_agent_os/21_factories/05_team_factory.py
---
...
<Steps>
  ...
  <Step title="Run the example">
    Save the code above as `team_factory.py`, then run:
    ```bash
    python team_factory.py
    ```
  </Step>
...
Full source: [cookbook/05_agent_os/21_factories/05_team_factory.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/05_agent_os/21_factories/05_team_factory.py)
