---
title: "Choose Model Configuration from a Trusted Tier"
description: "Use a verified subscription claim to choose low or high reasoning effort for the approved gpt-5.5 model without trusting client-controlled factory input."
source: cookbook/05_agent_os/21_factories/04_tiered_model.py
---

```python tiered_model.py
"""
...
<Steps>
  ...
  <Step title="Run the example">
    Save the code above as `tiered_model.py`, then run:
    ```bash
    python tiered_model.py
    ```
  </Step>
...
Full source: [cookbook/05_agent_os/21_factories/04_tiered_model.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/05_agent_os/21_factories/04_tiered_model.py)
