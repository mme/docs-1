---
title: "Build an Agent per Request"
description: "Register an AgentFactory that creates a fresh tenant-aware Agent for every run."
source: cookbook/05_agent_os/21_factories/01_basic.py
---

Register an AgentFactory that creates a fresh tenant-aware Agent for every run. The factory owns the public ID and database inherited by each product.
...
Full source: [cookbook/05_agent_os/21_factories/01_basic.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/05_agent_os/21_factories/01_basic.py)
