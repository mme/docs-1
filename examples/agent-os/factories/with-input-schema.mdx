---
title: "Validate Factory Input"
description: "Attach a Pydantic schema to an AgentFactory, send typed factory_input through the run API, and observe invalid input fail with HTTP 400 before construction."
source: cookbook/05_agent_os/21_factories/02_with_input_schema.py
---
...
Full source: [cookbook/05_agent_os/21_factories/02_with_input_schema.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/05_agent_os/21_factories/02_with_input_schema.py)
