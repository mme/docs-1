---
title: "Create the Showcase Agents"
description: "Define the shared PostgreSQL database, pgvector-backed Agno documentation knowledge, a focused RAG assistant, and a current web-and-finance researcher."
source: cookbook/05_agent_os/24_showcase/_agents.py
---
...
<Steps>
  ...
  <Step title="Install dependencies">
    ```bash
    uv pip install -U agno "psycopg[binary]" anthropic ddgs openai pgvector sqlalchemy yfinance
    ```
  </Step>
...
Full source: [cookbook/05_agent_os/24_showcase/_agents.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/05_agent_os/24_showcase/_agents.py)
