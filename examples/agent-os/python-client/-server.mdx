---
title: "Server"
description: "Serve the AgentOS used by every Python client example in this folder."
source: cookbook/05_agent_os/03_python_client/_server.py
---
...
<Steps>
  ...
  <Step title="Run the example">
    Save the code above as `_server.py`, then run:
    ```bash
    python _server.py
    ```
  </Step>
...
Full source: [cookbook/05_agent_os/03_python_client/_server.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/05_agent_os/03_python_client/_server.py)
