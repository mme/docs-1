---
title: "Serve a Team over A2A"
description: "Expose a research Team through the A2A team namespace."
source: cookbook/05_agent_os/15_a2a/team.py
---

Expose a research Team through the A2A team namespace. Its card and message routes live under `/a2a/teams/{id}`, not the Agent namespace.
...
Full source: [cookbook/05_agent_os/15_a2a/team.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/05_agent_os/15_a2a/team.py)
