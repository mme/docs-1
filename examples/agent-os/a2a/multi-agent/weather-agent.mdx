---
title: "Serve a Weather Specialist over A2A"
description: "Expose a weather Agent on the dedicated topology port."
source: cookbook/05_agent_os/15_a2a/multi_agent/weather_agent.py
---
...
Full source: [cookbook/05_agent_os/15_a2a/multi_agent/weather_agent.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/05_agent_os/15_a2a/multi_agent/weather_agent.py)
