---
title: "Orchestrate Multiple A2A Agents"
description: "Serve a trip-planning Agent whose async tools call the weather and Airbnb specialists through the first-party `A2AClient`."
source: cookbook/05_agent_os/15_a2a/multi_agent/trip_planning_a2a_client.py
---
...
Full source: [cookbook/05_agent_os/15_a2a/multi_agent/trip_planning_a2a_client.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/05_agent_os/15_a2a/multi_agent/trip_planning_a2a_client.py)
