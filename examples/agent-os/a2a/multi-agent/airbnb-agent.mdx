---
title: "Serve an Airbnb Specialist over A2A"
description: "Connect an Agent to the OpenBNB MCP server and expose it on the dedicated A2A topology port."
source: cookbook/05_agent_os/15_a2a/multi_agent/airbnb_agent.py
---
...
Full source: [cookbook/05_agent_os/15_a2a/multi_agent/airbnb_agent.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/05_agent_os/15_a2a/multi_agent/airbnb_agent.py)
