---
title: "Call an A2A Agent with the First-Party Client"
description: "Use `A2AClient` to send a message, thread a returned `context_id` into a follow-up, stream another turn, and handle an unavailable server."
source: cookbook/05_agent_os/15_a2a/client.py
---
...
Full source: [cookbook/05_agent_os/15_a2a/client.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/05_agent_os/15_a2a/client.py)
