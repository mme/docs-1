---
title: "Discover an A2A Agent Card"
description: "Read the Agent card from the entity-scoped discovery route with both the synchronous and asynchronous first-party client methods."
source: cookbook/05_agent_os/15_a2a/agent_card.py
---
...
Full source: [cookbook/05_agent_os/15_a2a/agent_card.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/05_agent_os/15_a2a/agent_card.py)
