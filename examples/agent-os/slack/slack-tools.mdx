---
title: "Search Slack and Work with Files"
description: "Combine channel history, thread expansion, workspace search, and file download/upload in one focused SlackTools Agent."
source: cookbook/05_agent_os/17_slack/slack_tools.py
---
...
Full source: [cookbook/05_agent_os/17_slack/slack_tools.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/05_agent_os/17_slack/slack_tools.py)
