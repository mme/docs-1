---
title: "Mount Multiple Slack Bots"
description: "Serve a research bot and an analysis bot from one AgentOS."
source: cookbook/05_agent_os/17_slack/multiple_bots.py
---
...
Full source: [cookbook/05_agent_os/17_slack/multiple_bots.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/05_agent_os/17_slack/multiple_bots.py)
