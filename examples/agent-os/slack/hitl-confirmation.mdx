---
title: "Confirm a Destructive Tool in Slack"
description: "Look up a subscription, then pause the persisted run with Approve and Deny actions before an irreversible cancellation tool executes."
source: cookbook/05_agent_os/17_slack/hitl_confirmation.py
---
...
Full source: [cookbook/05_agent_os/17_slack/hitl_confirmation.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/05_agent_os/17_slack/hitl_confirmation.py)
