---
title: "Collect Structured User Input in Slack"
description: "Draft a support ticket from the conversation, then pause with a Slack form so the requester supplies the priority and owning component."
source: cookbook/05_agent_os/17_slack/hitl_user_input.py
---
...
Full source: [cookbook/05_agent_os/17_slack/hitl_user_input.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/05_agent_os/17_slack/hitl_user_input.py)
