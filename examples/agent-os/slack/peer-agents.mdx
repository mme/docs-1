---
title: "Let One Slack App Address Another"
description: "Use two Slack apps in one workspace for one-way delegation."
source: cookbook/05_agent_os/17_slack/peer_agents.py
---
...
Full source: [cookbook/05_agent_os/17_slack/peer_agents.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/05_agent_os/17_slack/peer_agents.py)
