---
title: "Coordinate a Compound Incident in Slack"
description: "Combine user feedback, external execution, confirmation, and required user input in one persisted incident run."
source: cookbook/05_agent_os/17_slack/hitl_incident_commander.py
---
...
Full source: [cookbook/05_agent_os/17_slack/hitl_incident_commander.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/05_agent_os/17_slack/hitl_incident_commander.py)
