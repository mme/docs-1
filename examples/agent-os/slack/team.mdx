---
title: "Serve a Support Team in Slack"
description: "Route each Slack request to a technical specialist or a documentation specialist that can search current workspace discussions."
source: cookbook/05_agent_os/17_slack/team.py
---
...
Full source: [cookbook/05_agent_os/17_slack/team.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/05_agent_os/17_slack/team.py)
