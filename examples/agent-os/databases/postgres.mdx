...
description: "Use Postgres for production AgentOS persistence."
source: cookbook/05_agent_os/02_databases/postgres.py
---

Use Postgres for production AgentOS persistence. The synchronous adapter is the simplest default; select the asynchronous adapter when database work must remain non-blocking in an async application.
...
Full source: [cookbook/05_agent_os/02_databases/postgres.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/05_agent_os/02_databases/postgres.py)
