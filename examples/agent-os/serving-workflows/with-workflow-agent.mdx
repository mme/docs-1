---
title: "Chat with a WorkflowAgent through AgentOS"
description: "A WorkflowAgent decides whether a new message should execute the workflow or can be answered from workflow history."
source: cookbook/05_agent_os/09_serving_workflows/with_workflow_agent.py
---

A WorkflowAgent decides whether a new message should execute the workflow or can be answered from workflow history. The --demo client sends both turns over the served AgentOS API.

```python with_workflow_agent.py
"""
...
<Steps>
  ...
  <Step title="Run the example">
    Save the code above as `with_workflow_agent.py`, then run:
    ```bash
    python with_workflow_agent.py
    ```
  </Step>
...
Full source: [cookbook/05_agent_os/09_serving_workflows/with_workflow_agent.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/05_agent_os/09_serving_workflows/with_workflow_agent.py)
