---
title: "Serve a Workflow with AgentOS"
description: "Serve one two-step workflow as an HTTP resource."
source: cookbook/05_agent_os/09_serving_workflows/basic.py
---

Serve one two-step workflow as an HTTP resource. AgentOS adds discovery, execution, streaming, persisted-run, and WebSocket routes around the workflow.
...
Full source: [cookbook/05_agent_os/09_serving_workflows/basic.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/05_agent_os/09_serving_workflows/basic.py)
