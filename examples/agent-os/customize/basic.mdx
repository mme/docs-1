---
title: "Mount AgentOS on an existing FastAPI application"
description: "Pass an existing FastAPI instance through ``base_app`` so its routes and the AgentOS routes share one process."
source: cookbook/05_agent_os/06_customize/basic.py
---
...
Full source: [cookbook/05_agent_os/06_customize/basic.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/05_agent_os/06_customize/basic.py)
