---
title: "Add rate-limit and request-log middleware to AgentOS"
description: "Custom Starlette middleware can wrap the FastAPI app returned by ``AgentOS.get_app()``."
source: cookbook/05_agent_os/06_customize/custom_middleware.py
---
...
Full source: [cookbook/05_agent_os/06_customize/custom_middleware.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/05_agent_os/06_customize/custom_middleware.py)
