---
title: "Stream a custom tool event through AgentOS"
description: "An async tool yields a ``CustomEvent`` populated from request session state."
source: cookbook/05_agent_os/06_customize/custom_events.py
---
...
Full source: [cookbook/05_agent_os/06_customize/custom_events.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/05_agent_os/06_customize/custom_events.py)
