---
title: "Observe AgentOS run responses without private response classes"
description: "This middleware captures non-streaming JSON bodies and streaming SSE content for ``POST .../runs`` requests carrying ``X-APP-UUID``."
source: cookbook/05_agent_os/06_customize/response_middleware.py
---
...
Full source: [cookbook/05_agent_os/06_customize/response_middleware.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/05_agent_os/06_customize/response_middleware.py)
