---
title: "Mount Multiple WhatsApp Bot Instances"
description: "Mount two independently configured WhatsApp interfaces on one AgentOS."
source: cookbook/05_agent_os/19_whatsapp/multiple_instances.py
---
...
Full source: [cookbook/05_agent_os/19_whatsapp/multiple_instances.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/05_agent_os/19_whatsapp/multiple_instances.py)
