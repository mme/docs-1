---
title: "Send WhatsApp-Native Interactive Messages"
description: "Give an Agent focused WhatsApp tools for reply buttons, lists, location pins, and reactions."
source: cookbook/05_agent_os/19_whatsapp/interactive.py
---
...
Full source: [cookbook/05_agent_os/19_whatsapp/interactive.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/05_agent_os/19_whatsapp/interactive.py)
