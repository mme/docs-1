---
title: "Durable Continue"
description: "Durable continuation legs: HITL pause/continue that survives crashes."
source: cookbook/05_agent_os/background_tasks/durable_continue.py
---

```python durable_continue.py
...
<Steps>
  ...
  <Step title="Run the example">
    Save the code above as `durable_continue.py`, then run:
    ```bash
    python durable_continue.py
    ```
  </Step>
...
Full source: [cookbook/05_agent_os/background_tasks/durable_continue.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/05_agent_os/background_tasks/durable_continue.py)
