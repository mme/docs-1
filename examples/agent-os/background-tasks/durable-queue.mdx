---
title: "Durable Queue"
description: "AgentOS with a durable job queue: accepted background runs survive crashes."
source: cookbook/05_agent_os/background_tasks/durable_queue.py
---
...
<Steps>
  ...
  <Step title="Run the example">
    Save the code above as `durable_queue.py`, then run:
    ```bash
    python durable_queue.py
    ```
  </Step>
...
Full source: [cookbook/05_agent_os/background_tasks/durable_queue.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/05_agent_os/background_tasks/durable_queue.py)
