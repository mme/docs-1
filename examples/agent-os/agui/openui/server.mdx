---
title: "Render an Agno Agent with OpenUI"
description: "Serve OpenUI Lang from an Agno Agent over AG-UI."
source: cookbook/05_agent_os/16_agui/openui/server.py
---

Serve OpenUI Lang from an Agno Agent over AG-UI. The companion React client parses the stream into charts, follow-up actions, and validated forms.
...
Full source: [cookbook/05_agent_os/16_agui/openui/server.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/05_agent_os/16_agui/openui/server.py)
