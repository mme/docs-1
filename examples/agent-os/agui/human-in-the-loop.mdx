---
title: "Confirm a Backend Tool over AG-UI"
description: "Pause a real server-side tool call with requires_confirmation, stream the requirement to the frontend, and resume the persisted run after the user accepts or rejects it."
source: cookbook/05_agent_os/16_agui/human_in_the_loop.py
---
...
Full source: [cookbook/05_agent_os/16_agui/human_in_the_loop.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/05_agent_os/16_agui/human_in_the_loop.py)
