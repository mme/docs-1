---
title: "Serve Agents, a Team, and a Workflow for Remote* examples"
description: "This AgentOS is the native-protocol backend for the remote curriculum."
source: cookbook/05_agent_os/20_remote/servers/agentos_server.py
---
...
Full source: [cookbook/05_agent_os/20_remote/servers/agentos_server.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/05_agent_os/20_remote/servers/agentos_server.py)
