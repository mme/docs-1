---
title: "Remote Team and Workflow"
description: "RemoteTeam and RemoteWorkflow use the native AgentOS protocol while returning typed Agno Team and Workflow outputs to the caller."
source: cookbook/05_agent_os/20_remote/02_remote_team_and_workflow.py
---

```python remote_team_and_workflow.py
"""
...
Full source: [cookbook/05_agent_os/20_remote/02_remote_team_and_workflow.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/05_agent_os/20_remote/02_remote_team_and_workflow.py)
