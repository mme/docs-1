---
title: "Call Agno and Google ADK Agents through A2A"
description: "The Agno peer uses entity-scoped REST routes while Google ADK uses JSON-RPC at the server root."
source: cookbook/05_agent_os/20_remote/03_remote_via_a2a.py
---
...
Full source: [cookbook/05_agent_os/20_remote/03_remote_via_a2a.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/05_agent_os/20_remote/03_remote_via_a2a.py)
