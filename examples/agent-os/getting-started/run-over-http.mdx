---
title: "Run Over HTTP"
description: "Call the server from full_os.py through its raw FastAPI surface."
source: cookbook/05_agent_os/01_getting_started/run_over_http.py
---
...
Full source: [cookbook/05_agent_os/01_getting_started/run_over_http.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/05_agent_os/01_getting_started/run_over_http.py)
