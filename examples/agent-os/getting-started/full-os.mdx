---
title: "Full AgentOS Tour"
description: "Mount one agent, team, workflow, and knowledge base on a single AgentOS."
source: cookbook/05_agent_os/01_getting_started/full_os.py
---
...
Full source: [cookbook/05_agent_os/01_getting_started/full_os.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/05_agent_os/01_getting_started/full_os.py)
