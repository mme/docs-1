...
Full source: [cookbook/02_agents/03_context_management/instructions_with_state.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/02_agents/03_context_management/instructions_with_state.py)
