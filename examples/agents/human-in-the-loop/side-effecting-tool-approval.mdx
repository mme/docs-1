---
title: "Deterministic approval flow for a side-effecting tool"
description: "This example uses a local mock model, so it runs without provider credentials."
source: cookbook/02_agents/10_human_in_the_loop/side_effecting_tool_approval.py
---
...
```python side_effecting_tool_approval.py
...
Full source: [cookbook/02_agents/10_human_in_the_loop/side_effecting_tool_approval.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/02_agents/10_human_in_the_loop/side_effecting_tool_approval.py)
