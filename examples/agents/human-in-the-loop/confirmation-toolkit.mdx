...
Full source: [cookbook/02_agents/10_human_in_the_loop/confirmation_toolkit.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/02_agents/10_human_in_the_loop/confirmation_toolkit.py)
