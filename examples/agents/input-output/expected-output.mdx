...
Full source: [cookbook/02_agents/02_input_output/expected_output.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/02_agents/02_input_output/expected_output.py)
