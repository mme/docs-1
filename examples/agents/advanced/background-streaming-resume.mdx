---
title: "Background Streaming Resume"
description: "Example demonstrating background streaming with disconnect and resume."
source: cookbook/02_agents/14_advanced/background_streaming_resume.py
---

```python background_streaming_resume.py
"""
...
<Steps>
  ...
  <Step title="Run the example">
    Save the code above as `background_streaming_resume.py`, then run:
    ```bash
    python background_streaming_resume.py
    ```
  </Step>
...
Full source: [cookbook/02_agents/14_advanced/background_streaming_resume.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/02_agents/14_advanced/background_streaming_resume.py)
