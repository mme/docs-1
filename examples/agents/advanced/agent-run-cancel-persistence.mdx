...
Full source: [cookbook/02_agents/14_advanced/agent_run_cancel_persistence.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/02_agents/14_advanced/agent_run_cancel_persistence.py)
