---
title: "Background Execution Concurrency"
description: "Example demonstrating the concurrency limit for background runs."
source: cookbook/02_agents/14_advanced/background_execution_concurrency.py
---

```python background_execution_concurrency.py
"""
...
<Steps>
  ...
  <Step title="Run the example">
    Save the code above as `background_execution_concurrency.py`, then run:
    ```bash
    python background_execution_concurrency.py
    ```
  </Step>
...
Full source: [cookbook/02_agents/14_advanced/background_execution_concurrency.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/02_agents/14_advanced/background_execution_concurrency.py)
