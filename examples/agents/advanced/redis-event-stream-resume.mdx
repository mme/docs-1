---
title: "Redis Event Stream Resume"
description: "Example demonstrating cross-process streaming resume with RedisEventStream."
source: cookbook/02_agents/14_advanced/redis_event_stream_resume.py
---

```python redis_event_stream_resume.py
"""
...
<Steps>
  ...
  <Step title="Run the example">
    Save the code above as `redis_event_stream_resume.py`, then run:
    ```bash
    python redis_event_stream_resume.py
    ```
  </Step>
...
Full source: [cookbook/02_agents/14_advanced/redis_event_stream_resume.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/02_agents/14_advanced/redis_event_stream_resume.py)
