...
Full source: [cookbook/02_agents/14_advanced/interchange_model/all_providers.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/02_agents/14_advanced/interchange_model/all_providers.py)
