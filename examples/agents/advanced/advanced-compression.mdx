...
Full source: [cookbook/02_agents/14_advanced/advanced_compression.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/02_agents/14_advanced/advanced_compression.py)
