...
Full source: [cookbook/02_agents/14_advanced/custom_cancellation_manager.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/02_agents/14_advanced/custom_cancellation_manager.py)
