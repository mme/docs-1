---
title: "Payloads on Disk"
description: "By default the stored payload goes to AgentFS on the agent's database."
source: cookbook/02_agents/22_result_offloading/05_payloads_on_disk.py
---
...
Full source: [cookbook/02_agents/22_result_offloading/05_payloads_on_disk.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/02_agents/22_result_offloading/05_payloads_on_disk.py)
