---
title: "Delete Session Cascade"
description: "A stored result belongs to its session."
source: cookbook/02_agents/22_result_offloading/07_delete_session_cascade.py
---
...
Full source: [cookbook/02_agents/22_result_offloading/07_delete_session_cascade.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/02_agents/22_result_offloading/07_delete_session_cascade.py)
