---
title: "Where Results Live"
description: "Nothing is lost on the way: a tool hook still sees the whole result, and the payload is readable through the file store."
source: cookbook/02_agents/22_result_offloading/03_where_results_live.py
---
...
Full source: [cookbook/02_agents/22_result_offloading/03_where_results_live.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/02_agents/22_result_offloading/03_where_results_live.py)
