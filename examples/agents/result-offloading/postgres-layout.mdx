---
title: "PostgreSQL Layout"
description: "This example runs one agent against PostgreSQL, then queries both schemas."
source: cookbook/02_agents/22_result_offloading/06_postgres_layout.py
---

```python postgres_layout.py
"""
PostgreSQL Layout
=================
...
<Steps>
  ...
  <Step title="Run the example">
    Save the code above as `postgres_layout.py`, then run:
    ```bash
    python postgres_layout.py
    ```
  </Step>
...
Full source: [cookbook/02_agents/22_result_offloading/06_postgres_layout.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/02_agents/22_result_offloading/06_postgres_layout.py)
