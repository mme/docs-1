---
title: "The Result Store"
description: "`ResultStore` holds the settings and is usable without an agent: offload a payload, read a bounded page back, search it, list a session's live result ids, and sweep expired rows."
source: cookbook/02_agents/22_result_offloading/02_result_store.py
---
...
Full source: [cookbook/02_agents/22_result_offloading/02_result_store.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/02_agents/22_result_offloading/02_result_store.py)
