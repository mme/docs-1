...
Full source: [cookbook/02_agents/18_checkpointing/03_checkpoint_endpoints.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/02_agents/18_checkpointing/03_checkpoint_endpoints.py)
