...
Full source: [cookbook/02_agents/18_checkpointing/02_tool_error_persistence.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/02_agents/18_checkpointing/02_tool_error_persistence.py)
