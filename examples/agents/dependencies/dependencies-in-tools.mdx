...
Full source: [cookbook/02_agents/15_dependencies/dependencies_in_tools.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/02_agents/15_dependencies/dependencies_in_tools.py)
