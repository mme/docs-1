...
Full source: [cookbook/02_agents/17_fallback_models/04_fallback_callback.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/02_agents/17_fallback_models/04_fallback_callback.py)
