...
Full source: [cookbook/02_agents/08_guardrails/pii_detection.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/02_agents/08_guardrails/pii_detection.py)
