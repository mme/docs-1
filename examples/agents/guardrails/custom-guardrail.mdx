...
Full source: [cookbook/02_agents/08_guardrails/custom_guardrail.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/02_agents/08_guardrails/custom_guardrail.py)
