...
description: "Demonstrates the three-layer metadata resolution for Agents: agent.metadata < session.metadata < call-site metadata."
source: cookbook/02_agents/05_state_and_session/metadata_resolution.py
---
...
Full source: [cookbook/02_agents/05_state_and_session/metadata_resolution.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/02_agents/05_state_and_session/metadata_resolution.py)
