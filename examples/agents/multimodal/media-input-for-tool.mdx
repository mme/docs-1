...
Full source: [cookbook/02_agents/12_multimodal/media_input_for_tool.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/02_agents/12_multimodal/media_input_for_tool.py)
