...
Full source: [cookbook/02_agents/12_multimodal/video_caption.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/02_agents/12_multimodal/video_caption.py)
