...
Full source: [cookbook/02_agents/11_approvals/approval_post_hook.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/02_agents/11_approvals/approval_post_hook.py)
