...
Full source: [cookbook/02_agents/11_approvals/audit_approval_external.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/02_agents/11_approvals/audit_approval_external.py)
