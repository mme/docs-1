...
Full source: [cookbook/02_agents/09_hooks/post_hook_output.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/02_agents/09_hooks/post_hook_output.py)
