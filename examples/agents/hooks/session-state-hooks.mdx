...
Full source: [cookbook/02_agents/09_hooks/session_state_hooks.py](https://github.com/agno-agi/agno/blob/v3.0.4/cookbook/02_agents/09_hooks/session_state_hooks.py)
