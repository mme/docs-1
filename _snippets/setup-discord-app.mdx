...
Find your bot token in the Discord Developer Portal under "Bot" > "Token". Create an OpenAI API key in the OpenAI dashboard.
...
```bash
pip install discord.py agno openai
```
