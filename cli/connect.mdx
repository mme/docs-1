...
ChatGPT and Claude are hosted AI apps. Add AgentOS as a custom connector in each app. Agno Connect cannot edit or verify their settings, but it can print the MCP URL and setup steps:
