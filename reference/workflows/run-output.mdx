...
| `queue_attempt` | `Optional[int]` | `None` | Durable queue attempt that owns this run output |
...
| `event_index` | `Optional[int]` | `None` | Monotonic replay cursor for the stream. Values may contain gaps across retries and continued runs |
