...
"""Run `uv pip install agno openai sqlalchemy` to install dependencies."""
...
# Store team sessions and memories locally.
db = SqliteDb(db_file="tmp/team_performance.db")
...
db = SqliteDb(db_file="tmp/evals_demo.db")
