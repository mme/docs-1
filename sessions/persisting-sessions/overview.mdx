...
Sessions reuse the database drivers and guidance from the [Database overview](/database/overview):
...
- **Media** - Images, audio, files (optional). Offload to [object storage](/sessions/persisting-sessions/media-storage/overview)
