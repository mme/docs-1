...
description: "Scope user-owned AgentOS data and resources to the caller's user ID."
---

Authorization controls which operations a caller can perform. Per-user data isolation controls which rows a caller can see and write. User isolation applies throughout AgentOS to user-owned data and resources. Opt in with `user_isolation=True`:
