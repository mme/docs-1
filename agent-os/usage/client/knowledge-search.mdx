...
<Steps>
  ...
  <Step title="Start an AgentOS Server">
    Start the [client example server](/examples/agent-os/python-client/-server) on port 7777. It registers the knowledge base used by this client.
  </Step>

  <Step title="Upload content">
    [Upload at least one content item](/examples/agent-os/python-client/knowledge) before searching the knowledge base.
  </Step>
