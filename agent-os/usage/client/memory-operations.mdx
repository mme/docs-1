...
<Steps>
  ...
  <Step title="Start an AgentOS Server">
    Start the [client example server](/examples/agent-os/python-client/-server) on port 7777. It registers an agent with `update_memory_on_run=True` and a SQLite database for memories.
  </Step>
